...
app = FastAPI(title='Backstract Generated APIs - coll-67edec87326d42109dff93ec68d825a5', debug=False,
              docs_url='/nostalgic-thompson-594841aa41fd11f0a1456aebde786dcd81/docs',
              openapi_url='/nostalgic-thompson-594841aa41fd11f0a1456aebde786dcd81/openapi.json')
...
app.include_router(
    router,
    prefix='/nostalgic-thompson-594841aa41fd11f0a1456aebde786dcd81/api',
    tags=['APIs v1']
)
